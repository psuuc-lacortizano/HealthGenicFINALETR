function calc() {
    ...
    document.getElementById("Final").style = "max-width: 25rem; margin: auto; border: 3px solid black; width: 50%; margin-top: 45px; background-color:#fff176; border-radius: 20px; color:#ff6d00; margin-bottom: 30px"
}
